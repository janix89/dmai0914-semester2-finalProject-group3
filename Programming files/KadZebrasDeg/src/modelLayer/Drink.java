...
public class Drink extends Merchandise{
	...
	public void setAlcoholConcetration(double alcoholConcentration){this.alcoholConcentration=alcoholConcentration;}
	public void setMinQuantityInStock(int minQuantityInStock) {this.minQuantityInStock = minQuantityInStock;}

	//gets
	public int getQuantityInStock(){return quantityInStock;}
	public double getAlcoholConcetration(){return alcoholConcentration;}
